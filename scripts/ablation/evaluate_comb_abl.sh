...
python testing/evaluation_comb.py \
    ...
    --transformer_path exps/cogshader_HOI_comb_latents_no_depth_100000__optimizer_adamw__lr-schedule_cosine_with_restarts__learning-rate_1e-4/checkpoint-1400-convert
