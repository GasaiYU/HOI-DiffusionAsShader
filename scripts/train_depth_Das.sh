...
TRACKING_COLUMN="data/dexycb_filelist/training/training_depths.txt"

# validation parameters
TRACKING_MAP_PATH="./val_resources/depth_depth.mp4"
...
VALIDATION_IMAGES="./val_resources/depth_image.jpg"
  ...
  for lr_schedule in "${LR_SCHEDULES[@]}"; do
    for optimizer in "${OPTIMIZERS[@]}"; do
      for steps in "${MAX_TRAIN_STEPS[@]}"; do
        output_dir="./exps/cogshader_HOI_depth_test_${steps}__optimizer_${optimizer}__lr-schedule_${lr_schedule}__learning-rate_${learning_rate}/"
