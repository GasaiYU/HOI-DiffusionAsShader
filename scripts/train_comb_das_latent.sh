...
VIDEO_COLUMN="data/dexycb_filelist/training_latents_partial/training_video_latents.txt"
CAPTION_COLUMN="data/dexycb_filelist/training_latents_partial/training_prompt_embeds.txt"
TRACKING_COLUMN="data/dexycb_filelist/training_latents_partial/training_tracking_latents.txt"
NORMAL_COLUMN="data/dexycb_filelist/training_latents_partial/training_normal_latents.txt"
DEPTH_COLUMN="data/dexycb_filelist/training_latents_partial/training_depth_latents.txt"
SEG_MASK_COLUMN="data/dexycb_filelist/training_latents_partial/training_seg_mask_latents.txt"
HAND_KEYPOINTS_COLUMN="data/dexycb_filelist/training_latents_partial/training_hand_keypoints_latents.txt"

IMAGE_COLUMN="data/dexycb_filelist/training_latents_partial/training_image_latents.txt"
TRACKING_IMAGE_COLUMN="data/dexycb_filelist/training_latents_partial/training_tracking_images_latents.txt"
NORMAL_IMAGE_COLUMN="data/dexycb_filelist/training_latents_partial/training_normal_images_latents.txt"
DEPTH_IMAGE_COLUMN="data/dexycb_filelist/training_latents_partial/training_depth_images_latents.txt"
SEG_MASK_IMAGE_COLUMN="data/dexycb_filelist/training_latents_partial/training_seg_mask_images_latents.txt"
HAND_KEYPOINTS_IMAGE_COLUMN="data/dexycb_filelist/training_latents_partial/training_hand_keypoints_images_latents.txt"
  ...
  for lr_schedule in "${LR_SCHEDULES[@]}"; do
    for optimizer in "${OPTIMIZERS[@]}"; do
      for steps in "${MAX_TRAIN_STEPS[@]}"; do
        output_dir="./exps/cogshader_HOI_comb_latents_no_depth_${steps}__optimizer_${optimizer}__lr-schedule_${lr_schedule}__learning-rate_${learning_rate}/"
